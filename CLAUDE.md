...
- **Current build:** `APP_VERSION = 1.0.0`, `APP_BUILT = 2026-09-06` (see `webapp/serve.py`). The traditional-saroop display toggle is **default-ON** as of v2.10.1 (reader can switch to verbatim).
...
- Keep `MANIFEST.json`, `README.md`, `CHANGELOG.md`, and `MASTER-INDEX.md` in step when you bump (synced to 1.0.0 on 2026-09-06).
