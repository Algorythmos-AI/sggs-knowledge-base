...
- **Current build:** `APP_VERSION = 2.9.5`, `APP_BUILT = 2026-06-19` (see `webapp/serve.py`).
...
- Keep `MANIFEST.json`, `README.md`, `CHANGELOG.md`, and `MASTER-INDEX.md` in step when you bump (synced to 2.9.5 on 2026-06-19).
