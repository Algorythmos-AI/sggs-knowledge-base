...
- **Current build:** `APP_VERSION = 1.1.0`, `APP_BUILT = 2026-09-15` (see `webapp/serve.py`). The traditional-saroop display toggle is **default-ON** as of v2.10.1 (reader can switch to verbatim).
