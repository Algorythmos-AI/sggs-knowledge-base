...
- **Current build:** `APP_VERSION = 2.12.1`, `APP_BUILT = 2026-09-05` (see `webapp/serve.py`). The traditional-saroop display toggle is **default-ON** as of v2.10.1 (reader can switch to verbatim).
...
- Keep `MANIFEST.json`, `README.md`, `CHANGELOG.md`, and `MASTER-INDEX.md` in step when you bump (synced to 2.12.1 on 2026-09-05).
