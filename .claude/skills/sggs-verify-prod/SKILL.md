...
Production = web on Vercel at the canonical domain (`https://gurbanisoul.com`; `www.` and the old `sggs-knowledge-base.vercel.app` 308-redirect to it) + API on Render
