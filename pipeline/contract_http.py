...
"""Prove a running API honours the golden-vector contract — over HTTP, not in-process.
    ...
    python3 pipeline/contract_http.py --base http://127.0.0.1:7777 [--suites verify,search,...]

Replays the SAME projections pipeline/gen_golden_vectors.py records (its API / SEARCH /
