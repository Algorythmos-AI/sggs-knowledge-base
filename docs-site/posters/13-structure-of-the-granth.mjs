...
export default {
  ...
  description: 'Sri Guru Granth Sahib Ji opens with Japji Sahib, So Dar, So Purakh and Sohila on Angs 1–13, is ordered by thirty-one raags from Sireeraag on Ang 14 to Jaijaavantee on Ang 1353, and closes with the Sahaskriti saloks, Gatha, Phunhe, Chaubole, the Bhatts’ Swaiyye, the saloks beyond the Vaars, Guru Tegh Bahadur Ji’s saloks, Mundavani and Raagmala on Angs 1353–1430. Twenty-two Vaars sit inside the raags. Six Gurus, fifteen Bhagats, eleven Bhatts and three others wrote it; 60,658 lines in 4,706 compositions.',
  height: 900, verified: V,
  ...
  nodes: [
    ...
    { id: 'ruler14', kind: 'note', x: ax(14) - 45, y: BAR_Y + BAR_H + 44, w: 90, h: 30, lines: [{ text: 'Ang 14', size: 16 }], step: 'step-01' },
    { id: 'ruler700', kind: 'note', x: ax(700) - 50, y: BAR_Y + BAR_H + 44, w: 100, h: 30, lines: [{ text: 'Ang 700', size: 16 }], step: 'step-01' },
    { id: 'ruler1353', kind: 'note', x: ax(1353) - 55, y: BAR_Y + BAR_H + 44, w: 110, h: 30, lines: [{ text: 'Ang 1353', size: 16 }], step: 'step-01' },
    { id: 'ruler1430', kind: 'note', x: X1 - 110, y: BAR_Y + BAR_H + 44, w: 110, h: 30, lines: [{ text: 'Ang 1430', size: 16 }], step: 'step-01' },
    { id: 'openlbl', kind: 'note', x: 60, y: 420, w: 460, h: 110, lines: ['Angs 1–13 · the opening', { text: 'Japji Sahib (1–8, 385 lines) · So Dar (8–10)', size: 16 }, { text: 'So Purakh (10–12) · Sohila (12–13)', size: 16 }, { text: 'the Mool Mantar opens Ang 1', size: 16 }], step: 'step-02' },
    { id: 'raaglbl', kind: 'note', x: 560, y: 420, w: 480, h: 110, lines: ['Angs 14–1353 · thirty-one raags', { text: 'Sireeraag first, Jaijaavantee last', size: 16 }, { text: 'a raag’s span: the longest run of Angs', size: 16 }, { text: 'where it is the majority', size: 16 }], step: 'step-03' },
    { id: 'closelbl', kind: 'note', x: 1080, y: 420, w: 480, h: 110, lines: ['Angs 1353–1430 · after the raags', { text: 'Sahaskriti · Gatha · Phunhe · Chaubole', size: 16 }, { text: 'Swaiyye (1385–1409) · saloks beyond the Vaars', size: 16 }, { text: 'Salok M9 · Mundavani · Raagmala', size: 16 }], step: 'step-04' },
    { id: 'vaarlbl', kind: 'note', x: 60, y: 570, w: 460, h: 90, lines: ['22 Vaars, marked under the bar', { text: 'pauris by one Guru (or Satta & Balwand),', size: 16 }, { text: 'saloks interleaved from several', size: 16 }], step: 'step-05' },
    { id: 'voices', kind: 'note', x: 560, y: 570, w: 1000, h: 90, lines: ['The voices · 29 attributed authors', { text: 'six Gurus (M1–M5, M9) · fifteen Bhagats (Kabir Ji, Namdev Ji, Ravidas Ji, Sheikh Farid Ji …)', size: 16 }, { text: 'eleven Bhatts · Satta & Balwand · Bhai Mardana — Japji carries no author line', size: 16 }], step: 'step-06' },
    { id: 'count', kind: 'note', x: 60, y: 700, w: 1500, h: 60, lines: [{ text: '60,658 lines · 4,706 compositions · 1,430 Angs · 31 raags · 13 named sections · 22 Vaars · 54 themes in the concept index — every number read from the pinned database', size: 16 }], step: 'step-06' },
  ],
  edges,
  steps: [
    ...
    { id: 'step-06', title: 'The voices, and the numbers', caption: 'Six Gurus, fifteen Bhagats, eleven Bhatts, Satta and Balwand, and Bhai Mardana: 29 attributed authors, with Japji carrying no author line. 60,658 lines in 4,706 compositions; 13 named sections outside the raags; 54 themes in the concept index. Every figure is read from the database — the structure page lists them all.', link: '/scripture/structure/' },
  ],
};
