...
**Source:** `Siri-Guru-Granth-Sahib-in-Gurmukhi-with-Index.pdf` (1,483 pages → 1,430 Angs) · v2.9.2, built 2026-06-19 · 60,658 lines (char-for-char reconciled with the source) · 29,244 distinct words · 53 themes · per-Bhatt Swaiyye attribution · Vaar pauris correctly attributed.
