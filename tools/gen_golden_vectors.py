...
Usage:  python3 tools/gen_golden_vectors.py [path-to-db]   (default: db/sggs.sqlite)
"""
...
# ---------------------------------------------------------------------------
# Transport. In-process by default; tools/contract_http.py rebinds these three to replay the
...
def main():
    ...
    meta.update({
        'generator': 'tools/gen_golden_vectors.py (+ frontend/scripts/gen-pahar-vectors.mjs)',
        'db_sha256': db_hash,
        'tool_versions': {
